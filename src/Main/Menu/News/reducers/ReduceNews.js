export default function () {
  return [
    ...
    {
      id: 3,
      title: 'New flashes on the Sun. WHY?',
      description: 'It lasts for several minutes, releasing billions of megatons of energy in the TNT equivalent. Lets find out why this is happening and why humanity will not die from this yet.',
      news: 'la-la'
    }
  ]
}
