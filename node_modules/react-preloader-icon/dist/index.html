...
<head>
    ...
    <script type="text/javascript" src="browser.vendor.js"></script>
    <script type="text/javascript" src="browser.js"></script>
</head>
<body>

<header>
    <h1 class="blind">Demo - React Preloader Icon</h1>
</header>
                ...
                <form action="" class="icon-form__form">
                    <fieldset class="icon-form__form-set">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <input id="stroke_width" name="strokeWidth" type="number" value="8">
